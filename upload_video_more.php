...
$('#fileupload').fileupload(
    {
        ...
        multipart:true,
		    ...
		    if(data.result.sta) {
		    	// 上传成功：
		    	$(".preview").append("<div style='margin-top:10px;'><embed src="+data.result.previewSrc+" allowscriptaccess='always' allowfullscreen='true' wmode='opaque' width='280' height='200'></embed></div>");
